...
L# Figure S2 - Clone and Location
...
## controlling for clone non-independence - Supplementary Results
```{r}
...
We are interested in the overall taxonomic assignments of the different contigs in our dataset. 
...
ps.prok.tax
```
## Create a graph of the taxonomic information across the corals
```{r}
...
ggsave("../figures/taxonomy_barplot_Phylum.pdf", height = 14, width = 10)
```
