...
sample_data(bl.psobj)$Fate_after_SP1 <- factor(sample_data(bl.psobj.agg)$Fate_after_SP1, levels = c("Unaffected", "Recovered", "Will be diseased", "Diseased"))
...
ggsave("../figures/AMR_beta-lactamase_wPCA_08.11.25.pdf", width = 12, height = 8)
```
